      ...
      <div class="lg:col-span-2 space-y-4">
        ...
        $contacts = [
          ...
          ['icon'=>'mail','title'=>__('البريد الإلكتروني', 'arqamweb'),'value'=>'info@boyastore-eg.com','color'=>'var(--brand-blue)'],
                ['icon' => 'map-pin', 'title' => __('العنوان', 'arqamweb'), 'value' => __('34 ش محمد حمزة البطران، متفرع من الفريق علي فهمي، المنصورية - الهرم', 'arqamweb'), 'color' => 'var(--brand-orange)'], ['icon' => 'clock', 'title' => __('مواعيد التسليم', 'arqamweb'), 'value' => sprintf(
                        "%s\n%s",
                        __('الطلبات من 6 صباحًا إلى 3 عصرًا تُسلّم في نفس اليوم.', 'arqamweb'),
                        __('من 4 عصرًا إلى 12 منتصف الليل تُسلّم في اليوم التالي.', 'arqamweb')
                ),
