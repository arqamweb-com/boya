...
<div id="boya-site-loader" class="boya-site-loader" role="status" aria-live="polite">
  ...
  <span class="boya-site-loader__text"><?php esc_html_e('جاري تحميل الموقع', 'arqamweb'); ?></span>
</div>
...
<div class="hidden md:block bg-brand-navy text-white text-sm">
  <div class="container mx-auto px-6 py-2.5 flex items-center justify-between">
    <div class="flex items-center gap-6 opacity-95">
      ...
      <span><?php esc_html_e('توصيل سريع لكافة مناطق الجمهورية', 'arqamweb'); ?></span>
    </div>
    <div class="flex items-center gap-4 opacity-95">
      <span><?php esc_html_e('منتجات أصلية 100%', 'arqamweb'); ?></span>
      <span class="h-3 w-px bg-white/20"></span>
      <span><?php esc_html_e('دعم فني 24/7', 'arqamweb'); ?></span>
    </div>
  </div>
</div>
...
<div id="search-overlay"
  ...
  <div class="w-full max-w-2xl">
    <p class="text-white/50 text-center mb-6 text-sm tracking-widest"><?php esc_html_e('ابحث في منتجاتنا', 'arqamweb'); ?></p>
...
<div id="slide-cart"
  ...
  <div class="boya-cart-header flex items-center justify-between p-5 shrink-0">
    <div class="relative flex items-center gap-3">
      ...
      <div>
        <h3 class="text-xl font-black"><?php esc_html_e('سلة التسوق', 'arqamweb'); ?></h3>
    ...
    <button id="close-cart"
            ...
            aria-label="<?php esc_attr_e('إغلاق السلة', 'arqamweb'); ?>">
    ...
    <div class="boya-mini-cart p-6">
      ...
      <?php else: ?>
        <div class="boya-mini-cart__fallback text-center py-12">
          ...
          <p><?php esc_html_e('السلة فارغة', 'arqamweb'); ?></p>
        </div>
      <?php endif; ?>
    </div>
  </div>
  ...
  <div class="boya-cart-footer p-5 space-y-3 shrink-0<?php echo $cart_empty ? ' hidden' : ''; ?>">
    ...
    <a href="<?php echo esc_url(wc_get_cart_url()); ?>"
      ...
      <?php esc_html_e('عرض السلة', 'arqamweb'); ?>
    </a>
    <a href="<?php echo esc_url(wc_get_checkout_url()); ?>"
       class="boya-cart-primary-btn">
      <?php esc_html_e('إتمام الشراء', 'arqamweb'); ?>
    </a>
    <?php endif; ?>
  </div>
</div>
